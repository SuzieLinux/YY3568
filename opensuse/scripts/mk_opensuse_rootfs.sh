#!/bin/bash
#
# Script to create Open SuSE rootfs.ext4 for the YY3568 board
...
work_directory=$(pwd)
rootfs=$work_directory/opensuse_lsqt_rootfs

ROOTFS_SIZE=$(rsync -an --stats $rootfs test | grep "Total file size" | sed 's/[^0-9]//g' | xargs -I{} expr {} / $((1024*1024)) + 3900)"M"
